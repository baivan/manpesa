...
//users["totalUsers"] = $count[0]['totalUsers'];
    ...
    */
    ...
    public function contactSales(){
        ...
        $getContactsSalesQuery = "SELECT *  FROM sales s join payment_plan pp on s.paymentPlanID=pp.paymentPlanID join sales_type st on pp.salesTypeID=st.salesTypeID WHERE status >= 0 AND status < 2 AND contactsID=$contactsID ";
